...
/// </summary>
public class March7thTrackableEventHandler : MonoBehaviour
{
    ...
    GameObject March7thGameObject = null;
    ...
    {
        March7thGameObject = (GameObject)Instantiate(Resources.Load(AvaterConstant.March7thPath));
        March7thGameObject.transform.position = transform.position;
        March7thGameObject.transform.parent = transform;
    }

    protected virtual void OnTrackingLost()
    {
        Destroy(March7thGameObject);
    }
