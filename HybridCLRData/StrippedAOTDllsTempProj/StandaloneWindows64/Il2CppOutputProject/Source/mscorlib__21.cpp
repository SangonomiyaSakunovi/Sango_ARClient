...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void StackTrace_GetFullNameForStackTrace_m4B2BACBB18F8441E1D601567D3A9E7D6E2B16F01 (StackTrace_t7C150C7C14136F985311A83A93524B1019F70853* __this, StringBuilder_t* ___0_sb, MethodBase_t* ___1_mi, bool ___2_needsNewLine, bool* ___3_skipped, bool* ___4_isAsync, const RuntimeMethod* method) 
{
	...
	bool* G_B10_1 = NULL;
	{
		...
		NullCheck(L_2);
		bool L_3;
		L_3 = VirtualFuncInvoker0< bool >::Invoke(52, L_2);
		if (!L_3)
		{
			goto IL_004f;
		}
	}
	{
		...
		NullCheck(L_4);
		bool L_5;
		L_5 = VirtualFuncInvoker0< bool >::Invoke(53, L_4);
		if (L_5)
		{
			goto IL_004f;
		}
	}
	{
		...
		NullCheck(L_6);
		Type_t* L_7;
		L_7 = VirtualFuncInvoker0< Type_t* >::Invoke(61, L_6);
		V_0 = L_7;
		Type_t* L_8 = V_0;
		NullCheck(L_8);
		MethodInfoU5BU5D_tDF3670604A0AECF814A0B0BA09B91FBF0D6A3265* L_9;
		L_9 = VirtualFuncInvoker1< MethodInfoU5BU5D_tDF3670604A0AECF814A0B0BA09B91FBF0D6A3265*, int32_t >::Invoke(134, L_8, ((int32_t)62));
		V_2 = L_9;
		V_3 = 0;
		goto IL_0049;
	}
...
IL_004f:
	{
		...
		NullCheck(L_24);
		bool L_26;
		L_26 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(32, L_24, L_25);
...
IL_00ad:
	{
		...
		NullCheck(L_56);
		bool L_57;
		L_57 = VirtualFuncInvoker0< bool >::Invoke(32, L_56);
		if (!L_57)
		{
			goto IL_0149;
		}
	}
	{
		...
		MethodInfo_t* L_59;
		L_59 = VirtualFuncInvoker0< MethodInfo_t* >::Invoke(47, ((MethodInfo_t*)CastclassClass((RuntimeObject*)L_58, MethodInfo_t_il2cpp_TypeInfo_var)));
		___1_mi = L_59;
		MethodBase_t* L_60 = ___1_mi;
		NullCheck(L_60);
		TypeU5BU5D_t97234E1129B564EB38B8D85CAC2AD8B5B9522FFB* L_61;
		L_61 = VirtualFuncInvoker0< TypeU5BU5D_t97234E1129B564EB38B8D85CAC2AD8B5B9522FFB* >::Invoke(34, L_60);
		V_5 = L_61;
...
IL_0172:
	{
		...
		NullCheck(L_91);
		bool L_92;
		L_92 = VirtualFuncInvoker0< bool >::Invoke(52, L_91);
		if (!L_92)
		{
			goto IL_0198;
		}
	}
	{
		...
		NullCheck(L_93);
		bool L_94;
		L_94 = VirtualFuncInvoker0< bool >::Invoke(53, L_93);
		if (L_94)
		{
			goto IL_0198;
		}
	}
	{
		...
		NullCheck(L_95);
		Type_t* L_96;
		L_96 = VirtualFuncInvoker0< Type_t* >::Invoke(61, L_95);
		V_8 = L_96;
	}
...
IL_0012:
	{
		...
		L_6 = VirtualFuncInvoker1< MethodInfoU5BU5D_tDF3670604A0AECF814A0B0BA09B91FBF0D6A3265*, int32_t >::Invoke(134, L_5, ((int32_t)62));
		V_1 = L_6;
