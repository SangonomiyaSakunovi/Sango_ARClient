...
IL_0029:
	{
		int32_t L_5;
		L_5 = List_1_get_Count_m5AE846231CC1E15D5E62E1A6B32760306AD94D91_inline(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 17));
		return ((int32_t)il2cpp_codegen_subtract(L_5, 1));
	}
}
...
IL_0029:
	{
		int32_t L_5;
		L_5 = List_1_get_Count_mE780D5A4373D244D420DBB851419C525F52259C4_inline(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 17));
		return ((int32_t)il2cpp_codegen_subtract(L_5, 1));
	}
}
